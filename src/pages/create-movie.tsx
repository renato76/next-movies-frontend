...
const CreateMovie = () => {
  ...
  return (
    <div className="text-center pt-10 pb-20 h-full bg-[#323235]">
      <h1 className="text-white text-4xl text-bold">Create A Movie</h1>
      {!session && (
        <>
          <div>
            <h2 className="text-white mt-6 text-lg">
      ...
      {session && (
        ...
        >
          <div className="flex justify-center mt-6 w-5/6 md:max-w-[650px] m-auto text-start rounded-lg px-5 py-6 bg-[#f0f0f0]">
            <Form>
