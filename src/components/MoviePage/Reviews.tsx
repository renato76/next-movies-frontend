          ...
          <>
            <div className="flex flex-col items-center">
              ...
              {(cookies.username || session) && (
                <p
                  className="font-bold cursor-pointer text-[#1ad3ae]"
              ...
              {review?.map((review) => (
                <div className="overflow-y-scroll bg-[#f0f0f0] border border-[#c7c5c5] rounded-xl shadow-2xl my-6 px-6 md:px-20 py-6">
                  <div className="pb-2 ">
                    ...
                    <div className="bg-[#1ad3ae] text-sm py-[2px] w-[44px] text-white flex justify-center items-center rounded-lg mt-1">
                      <p>
